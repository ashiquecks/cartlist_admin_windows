...
class AddSponsordProduct extends StatefulWidget {
  const AddSponsordProduct({super.key});

  @override
  State<AddSponsordProduct> createState() => _AddSponsordProductState();
}

class _AddSponsordProductState extends State<AddSponsordProduct> {
  final GlobalKey<FormState> _formKey = GlobalKey<FormState>();

  Future<void> uploadSponserdProduct({
    required String quantityCategory,
    required String productCategory,
  }) async {
    try {
      String uri = "http://18.183.210.225//cartlist_api/addsponserdproduct.php";
